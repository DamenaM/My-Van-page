    ...
    useEffect(() => {
      setFilteredEmployees(  employees.filter(employee => {
          return (
            ...
            (!experience ||   (experience === "LESS_THAN_10"    ? employee.experience < 10 : employee.experience >= 10))
          )
        })
      )
    ...
    return (
      <div className="App">
        <select onChange={e => setDepartment(e.target.value)}>
              <option value="" disabled default selected>  Select department
              </option>
